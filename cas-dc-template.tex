...
\begin{figure}
	...
	\addplot[] table[x expr=\thisrowno{0},y expr=(\thisrowno{1})] {ASCII/output1k.txt};
%	\addplot[] table[x expr=\thisrowno{0},y expr=(\thisrowno{4})] {ASCII/output1k.txt};
%	\addplot[] table[x expr=\thisrowno{0},y expr=(\thisrowno{6})] {ASCII/output1k.txt};
	\end{axis}
	\end{tikzpicture}
	\caption{Operation conditions.}
